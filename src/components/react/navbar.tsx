      ...
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 p-4">
          ...
          >
            ...
            <span
              className={
                'text-foreground/90 uppercase transition-opacity duration-200 ease-in-out dark:text-white'
              }
            >
              {SITE.title}
            </span>
                  ...
                  >
                    <Link
                      ...
                      className={cn(
                        ...
                        'relative px-1 py-1',
                        'after:bg-primary after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:transition-all after:duration-300',
