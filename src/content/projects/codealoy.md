---
name: 'Codealoy'
description: 'An open-source interactive learning platform to learn programming & web development in Bangla'
tags:
  [
    'nextjs',
    'tailwindcss',
...
- **[Next.js](https://nextjs.org)** – React framework for building the platform with server-side rendering and optimal performance.
...
- **[MDX](https://mdxjs.com)** – Markdown with JSX support for creating rich, interactive content.
- **[Sandpack](https://sandpack.codesandbox.io)** – Interactive code editor and live preview environment by CodeSandbox.
- **[Hono](https://hono.dev)** – Fast and lightweight web framework for the Edge.
- **[Lucia Auth](https://lucia-auth.com)** – Modern authentication library with built-in security features.
